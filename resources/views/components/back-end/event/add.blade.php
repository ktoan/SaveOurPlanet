        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-block">
                    <h4 class="sub-title">Thêm sự kiện</h4>
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            >
                            <div class="col-sm-10">
                                <input required placeholder="Tên sự kiện..." type='text' name="name" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label"
                        ...
                        <div class="form-group row">
                            ...
                            >
                            <div class="col-sm-10">
                                <input required placeholder="Địa điểm..." type='text' name="location" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                @elseif(isset($message) && $message=='Thành công rồi nè!!!')
