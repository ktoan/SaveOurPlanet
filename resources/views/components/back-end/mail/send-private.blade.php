        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-block">
                    <h4 class="sub-title">Gửi mail đến <span class="text-lowercase">{{$data->email}}</span></h4>
                    <form action="" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            >
                            <div class="col-sm-10">
                                <textarea rows="5" cols="5" class="form-control" name="message" placeholder="Nội dung"></textarea>
                            </div>
                        </div>
